...
export default class RentHistory extends Component {
  constructor(props) {
    super(props);
    this.state = {
      allTransactions: [],
...
if (enteredText[0] === "C"){
  ...
  renderItem = ({ item, i }) => {
    ...
    var transactionType =
      item.transaction_type === "rent" ? "rented" : "returned";
    return (
        ...
        <ListItem key={i} bottomDivider>
          ...
          <ListItem.Content>
            ...
            <ListItem.Subtitle style={styles.subtitle}>
              {`This car is ${transactionType} by ${item.user_name}`}
            </ListItem.Subtitle>
            <View style={styles.lowerLeftContaiiner}>
              <View style={styles.transactionContainer}>
                ...
                <Icon
                  ...
                  color={
                    item.transaction_type === "rent" ? "#78D304" : "#0364F4"
                  }
                />
              </View>
